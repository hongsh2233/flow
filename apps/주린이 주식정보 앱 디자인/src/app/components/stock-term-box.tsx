...
export function StockTermBox() {
  ...
  return (
    <div className="bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl p-4 border-2 border-yellow-200 relative">
      <button
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <button
            onClick={nextTerm}
            className="text-xs text-orange-700 hover:text-orange-800 font-medium underline"
          >
            다음 용어 보기 →
          </button>
        </div>
