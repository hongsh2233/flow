...
async def lifespan(app: FastAPI):
    ...
    breakout_screening_scheduler.start()
    leader_screening_scheduler.start()
    ...
    breakout_screening_scheduler.shutdown()
    leader_screening_scheduler.shutdown()
