...
def run_migration(db=None):
    ...
    try:
        ...
        if not has_start_date:
            ...
            db.execute(text("ALTER TABLE main_page_items ADD COLUMN start_date VARCHAR(10) NULL AFTER is_visible"))
            db.commit()
        ...
        if not has_end_date:
            ...
            db.execute(text("ALTER TABLE main_page_items ADD COLUMN end_date VARCHAR(10) NULL AFTER start_date"))
            db.commit()
