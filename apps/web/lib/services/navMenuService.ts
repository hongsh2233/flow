...
const DEFAULT_NAV_LIST: NavMenuItem[] = [
  ...
  { id: 3, name: '시황자료', icon: 'icon_chat', link: '/news?board=B002', matchPaths: ['/news?board=B002', '/news?board=B002&tab=market', '/news?board=B002&tab=study', '/news?board=B003', '/news?board=B003&tab=market', '/news?board=B003&tab=study'] },
