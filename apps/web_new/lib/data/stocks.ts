...
export const kospiSectors: SectorData[] = [
...
export const kosdaqSectors: SectorData[] = [
...
export const marketCapStocks: MarketCapStock[] = [
...
export const risingStocks: RisingStock[] = [
...
export const favoriteStocksPage: FavoriteStock[] = [
