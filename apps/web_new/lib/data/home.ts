...
export const realtimeSearch: RealtimeSearchItem[] = [
...
export const kospiVolume: VolumeStock[] = [
...
export const kosdaqVolume: VolumeStock[] = [
...
export const kospiValue: ValueStock[] = [
...
export const kosdaqValue: ValueStock[] = [
...
export const favoriteStocks: FavoriteStockItem[] = [
...
export const exchangeRates: ExchangeRateItem[] = [
